    ...
    <div className="min-h-screen bg-white flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {galleryImages.map((image) => (
              <div key={image.id} className="group relative overflow-hidden rounded-lg shadow-lg bg-gray-300 h-64">
                <div className="w-full h-full bg-gradient-to-br from-gray-400 to-gray-500 flex items-center justify-center text-white font-bold group-hover:from-red-500 group-hover:to-red-600 transition">
                  {image.title}
                </div>
      ...
      <section className="bg-gray-50 py-12 px-4 text-center">
        ...
        <a 
          ...
          className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded inline-block transition"
        >
          Call Now
        </a>
      </section>
